...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        #     executable='rviz2',
        #     name='rviz2',
        #     arguments=['-d', "ros2/carbi/install/carbi_visualization/rviz/display.rviz"],
        #             # arguments=["-d", os.path.join(robot_description_dir, "rviz", "display.rviz")],
