...
def generate_launch_description():
    ...
    default_params_file = "/ros2/carbi/src/carbi_navigation/config/mapper_params_online_async.yaml" #os.path.join(get_package_share_directory("articubot_one"), 'config', 'mapper_params_online_async.yaml')
