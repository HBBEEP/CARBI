...
: ${AMENT_CURRENT_PREFIX:="/ros2/carbi/install/carbi_bridge"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/carbi_bridge/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/carbi_bridge/environment/path.sh"
